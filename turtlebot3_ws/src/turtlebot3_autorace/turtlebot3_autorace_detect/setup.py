...
setup(
    ...
    entry_points={
        'console_scripts': [
            ...
            'detect_parking = turtlebot3_autorace_detect.detect_parking:main',
            'detect_signcombine = turtlebot3_autorace_detect.detect_signcombine:main',
            'detect_stop_tunnel = turtlebot3_autorace_detect.detect_stop_tunnel:main',
